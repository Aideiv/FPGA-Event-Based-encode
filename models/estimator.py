...
class LocalGeometryEncoder(nn.Module):
    """ A vectorized kernel mixture approach for encoding local point cloud geometry. """
    ...
    def __repr__(self):
        return f'LocalGeometryEncoder(d={self.d}, alpha={self.alpha}, radius={self.radius}.)'
